...
SECRET_KEY = 'django-insecure-b*zg6-elk#yw8b@&983z-#e)8avkrlvzhsjz2z1qq-n+)z5wiy'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
ALLOWED_HOSTS = ['http://localhost:3000', '127.0.0.1', 'localhost']
CORS_ORIGIN_ALLOW_ALL = False
CORS_ALLOW_METHODS = ['POST', "PUT", "DELETE"]
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_NAME': 'refresh_token',
...
AUTH_USER_MODEL = "books.FullUser"
